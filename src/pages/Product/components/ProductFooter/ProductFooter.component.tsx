...
const ProductFooter = () => {
	...
	return (
		<ProductFooterPaper sx={{padding: {xs: '40px 0', md: '70px 0', lg: '80px 0'}}}>
			<Grid container maxWidth="1075px" justifyContent="flex-start">
				<Grid item xs={12} md={9} >
					<ProductFooterTitle sx={{fontSize: {xs: '40px', md: '48px' , lg: '68px', lineHeight: 1.15}, paddingBottom: {xs: '20px', md: '10px'}}} >{t('productPage.pageFooter.title')}</ProductFooterTitle>
				</Grid>
